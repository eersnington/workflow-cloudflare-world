...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun']}>
  <Tab value="npm">
    <CodeBlock>npm i workflow nitro rollup</CodeBlock>
  </Tab>
  <Tab value="pnpm">
    <CodeBlock>pnpm i workflow nitro rollup</CodeBlock>
  </Tab>
  <Tab value="yarn">
    <CodeBlock>yarn add workflow nitro rollup</CodeBlock>
  </Tab>
  <Tab value="bun">
    <CodeBlock>bun add workflow nitro rollup</CodeBlock>
  </Tab>
</Tabs>
